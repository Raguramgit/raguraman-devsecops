...
This is a task-driven, execution-first engineering repository.
...
## 📂 How to Add Your Work (Module-Wise)

Inside each module folder:

### 1. Create a folder with your name or task number
...
- ❌ No copy-paste repos
- ❌ No blind execution without understanding
- ❌ No private repos for Batch-13 work
